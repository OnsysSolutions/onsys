...
import { MockConvite } from "@/(auth)/convite/[token]/invite-login-modal";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4">
      <Card className="w-full max-w-md border-border/50 shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Aceite o convite para participar da conta
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Alert>
            <AlertDescription className="text-sm">
              Ao aceitar este convite, você terá acesso à conta{" "}
              <strong>{inviteData.accountName}</strong> com permissões de{" "}
